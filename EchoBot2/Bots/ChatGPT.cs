...
using EchoBot2.Bots;
using static EchoBot1.Bots.ChatGPT;
...
namespace EchoBot1.Bots
{
    ...
    {
        const string AzureOpenAIEndpoint = "https://👉endpoint.openai.azure.com";  //👉replace it with your Azure OpenAI Endpoint
        const string AzureOpenAIModelName = "👉deployment"; //👉repleace it with your Azure OpenAI Model Name
        const string AzureOpenAIToken = "👉apikey"; //👉repleace it with your Azure OpenAI Token
